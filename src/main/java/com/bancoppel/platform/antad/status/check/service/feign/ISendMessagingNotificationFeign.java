...
/**
 * Interfaz de tipo Feign que consume el Api SendMessagingNotification.
 * 
 * @author Leon Fernando.
 */
@FeignClient(url = FeignConstants.SEND_MESSAGING_NOTIFICATION_URL,
    name = FeignConstants.SEND_MESSAGING_NOTIFICATION_NAME)
public interface ISendMessagingNotificationFeign {
   ...
   */
  @HandledProcedure(name = ApiConstants.LOG_SEND_MESSAGING_NOTIFICATION,
      value = ApiConstants.LOG_SEND_MESSAGING_NOTIFICATION,
  ...
  @PostMapping(value = FeignConstants.SEND_MESSAGING_NOTIFICATION_ENDPOINT)
  ResponseEntity<MessagingNotificationsResponse> sendMessagingNotification(
      ...
      @RequestBody MessagingNotificationsRequest request);
}
